...
""",
    ...
    def test_verbose_output(self):
        ...
        stderr = io.StringIO()
        call_command(
            "render_patterns", dry_run=True, stdout=stdout, stderr=stderr, verbosity=2
        )
        self.assertIn(
            """Target directory: dpl-rendered-patterns. Dry run, not writing files to disk
Group: atoms
Group: icons
Pattern: icon.html
...
""",
    ...
    def test_quiet_output(self):
        ...
        stderr = io.StringIO()
        call_command(
            "render_patterns", dry_run=True, stdout=stdout, stderr=stderr, verbosity=0
        )
    ...
    def test_shows_wrap_fragment(self):
        ...
        self.assertIn(
            "Writing fragment patterns wrapped in base template", stderr.getvalue()
        )
